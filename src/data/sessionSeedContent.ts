...
import { CANONICAL_VENUES, GELATO_ROMA_VENUE, MAIN_STREET_DINER_VENUE, RIVERSIDE_PARK_VENUE, WESTSIDE_LIBRARY_VENUE } from "./canonicalVenues";
...
Object.freeze({ id: "jack-movie", friendId: CORE_SOCIAL_CHARACTERS.jack.id, author: CORE_SOCIAL_CHARACTERS.jack.displayName, text: "That movie was better than I expected.", timestamp: "11:52 PM", createdAt: "2010-10-19T23:52:00-07:00", kind: "status" as const, visibility: "friends" as const, profileWallEligible: true, origin: "seed" as const }),
      Object.freeze({ id: "jack-matt-2010-photo", friendId: CORE_SOCIAL_CHARACTERS.jack.id, author: CORE_SOCIAL_CHARACTERS.jack.displayName, text: "@Matt Ciao, bello", mentions: Object.freeze([{ token: "@Matt", actor: Object.freeze({ kind: "canonical" as const, characterId: CORE_SOCIAL_CHARACTERS.matt.id, displayName: CORE_SOCIAL_CHARACTERS.matt.displayName }) }]), timestamp: "Mon 10:34 PM", createdAt: "2010-10-18T22:34:00-07:00", kind: "photo" as const, visibility: "friends" as const, mediaId: "jack-matt-01" as const, taggedCharacterIds: Object.freeze([CORE_SOCIAL_CHARACTERS.matt.id]), profileWallEligible: true, origin: "seed" as const }),
...
Object.freeze({ id: "jack-profile-picture-update", friendId: CORE_SOCIAL_CHARACTERS.jack.id, author: CORE_SOCIAL_CHARACTERS.jack.displayName, text: "updated his profile picture.", timestamp: "Sep 5", createdAt: "2010-09-05T18:00:00-07:00", kind: "photo" as const, visibility: "custom" as const, customAudienceIncludesUser: false, mediaId: "jack-profile-picture" as const, profileWallEligible: true, origin: "seed" as const }),
      ...
      Object.freeze({ id: "jack-matt-2008-photo", friendId: CORE_SOCIAL_CHARACTERS.jack.id, author: CORE_SOCIAL_CHARACTERS.jack.displayName, text: "@Matt your dad still makes the best lasagna btw lol", mentions: Object.freeze([{ token: "@Matt", actor: Object.freeze({ kind: "canonical" as const, characterId: CORE_SOCIAL_CHARACTERS.matt.id, displayName: CORE_SOCIAL_CHARACTERS.matt.displayName }) }]), timestamp: "Sep 20", createdAt: "2008-09-20T19:32:00-07:00", kind: "photo" as const, visibility: "friends" as const, mediaId: "jack-matt-03" as const, taggedCharacterIds: Object.freeze([CORE_SOCIAL_CHARACTERS.matt.id]), profileWallEligible: true, origin: "seed" as const }),
      Object.freeze({ id: "jack-matt-family-2007-photo", friendId: CORE_SOCIAL_CHARACTERS.jack.id, author: CORE_SOCIAL_CHARACTERS.jack.displayName, text: "@Matt", mentions: Object.freeze([{ token: "@Matt", actor: Object.freeze({ kind: "canonical" as const, characterId: CORE_SOCIAL_CHARACTERS.matt.id, displayName: CORE_SOCIAL_CHARACTERS.matt.displayName }) }]), timestamp: "Jun 16", createdAt: "2007-06-16T18:40:00-07:00", kind: "photo" as const, visibility: "friends" as const, mediaId: "jack-matt-family" as const, taggedCharacterIds: Object.freeze([CORE_SOCIAL_CHARACTERS.matt.id]), profileWallEligible: true, origin: "seed" as const }),
  ...
  twitterReplies: Object.freeze([
    ...
    Object.freeze({ id: "jack-reply-matt-matteo-ricci", targetTweetId: "matt-back-to-the-mac", friendId: CORE_SOCIAL_CHARACTERS.jack.id, displayName: CORE_SOCIAL_CHARACTERS.jack.displayName, text: "ok matteo ricci", timestamp: "2010-10-19T22:52:00-07:00", classification: "RECONSTRUCTED CHARACTER CONTENT" as const, origin: "seed" as const }),
  ]),
  ...
  foursquare: Object.freeze({
    venues: Object.freeze([
      Object.freeze({ ...CANONICAL_VENUES["night-owl"], category: "Coffee Shop", address: "214 4th Street", distance: "0.2 mi", mayor: "June", tip: Object.freeze({ id: "night-owl-tip", author: "June", text: "The coffee is strongest after ten.", origin: "seed" as const }), origin: "seed" as const }),
      ...
      Object.freeze({ ...CANONICAL_VENUES["cedar-books"], category: "Bookstore", address: "91 Cedar Avenue", distance: "0.5 mi", mayor: "Mia", tip: null, origin: "seed" as const }),
      ...
      Object.freeze({ ...GELATO_ROMA_VENUE, category: "Ice Cream / Gelato", address: "", distance: "1.0 mi", mayor: "", tip: null, origin: "seed" as const }),
      Object.freeze({ ...CANONICAL_VENUES.hk, category: "Chinese Restaurant", address: "", distance: "0.7 mi", mayor: "", tip: null, origin: "seed" as const }),
    ]),
